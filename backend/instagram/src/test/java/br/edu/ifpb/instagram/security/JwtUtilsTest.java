...
class JwtUtilsTest {
    ...
    @BeforeEach
    void setUp() {
        // Inicializa os mocks do Mockito para as dependências com @Mock
        MockitoAnnotations.openMocks(this);
        // Instancia a classe real que queremos testar
    ...
    void deveGerarTokenComSucesso() {
        // Configura o mock para retornar um nome de usuário quando chamado
